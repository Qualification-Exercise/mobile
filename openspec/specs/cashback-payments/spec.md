# cashback-payments Specification

## Purpose

TBD - created by import-wdk-wallet-screens. Covers the merchant scan-to-pay flow and the resulting cashback coupon issuance, matching the WDK Wallet design canvas screens 09-10.
