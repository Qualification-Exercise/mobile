# wallet-transfers Specification

## Purpose

TBD - created by import-wdk-wallet-screens. Covers the receive, send, and biometric transaction-approval flow, matching the WDK Wallet design canvas screens 06-08.
